...
public class Button {
    ...
    public Button(Texture newImage, int x, int y, int hFrames, int vFrames, boolean center){
    ...
    public boolean hover(int x1, int y1){ return pressed; }
